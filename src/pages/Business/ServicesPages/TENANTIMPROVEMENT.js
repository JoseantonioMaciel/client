...
import Image from "../IMAGES/Ser7.jpg";

import Card from "@mui/material/Card";
import { OURTENANTIMPROVEMENT, SCHEDUELEACONSULTATION, LETSBEGIN, IMG } from "../ServicesData/TENANTIMPROVEMENTINFO";
  ...
  return (
    <Paper className={styles.section}>
      ...
      <Box sx={{ flexGrow: 1 }}>
        ...
        >
          <Grid item xs={12}>
            <Card elevation={0}>{OURTENANTIMPROVEMENT}</Card>
          </Grid>
        </Grid>
        <br /> {/* Remove This*/}
